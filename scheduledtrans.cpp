    ...
    ui(new Ui::CScheduledTrans)
{
  ...
  connect(ui->pCBUnit,SIGNAL(currentIndexChanged(QString)),this,SLOT(setDirty()));
  connect(ui->pCBAccount,SIGNAL(currentIndexChanged(QString)),this,SLOT(setDirty()));
  connect(ui->pCBPayee,SIGNAL(currentIndexChanged(QString)),this,SLOT(setDirty()));
  ...
  connect(ui->pCBCategory,SIGNAL(currentIndexChanged(QString)),this,SLOT(updateStatusControls()));
  connect(ui->pCBLimits,SIGNAL(currentIndexChanged(QString)),this,SLOT(setDirty()));
